...
var Ruta2Controller = /** @class */ (function () {
    function Ruta2Controller() {
        this.conexion = {
            user: "usuario1",
            password: "321",
            connectString: "(DESCRIPTION =(LOAD_BALANCE = ON)(FAILOVER = ON)(ADDRESS =(PROTOCOL = TCP)(HOST = localhost)(PORT = 1521))(ADDRESS = (PROTOCOL = TCP)(HOST = localhost)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=XE)(FAILOVER_MODE=(TYPE=SELECT)(METHOD = BASIC))))"
    ...
    Ruta2Controller.prototype.index = function (req, res) {
        //res.send('ruta 2');
    };
    Ruta2Controller.prototype.init = function (req, res) {
    ...
    Ruta2Controller.prototype.run = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connection = _a.sent();
                        return [4 /*yield*/, connection.execute("SELECT * FROM disco")];
                    case 2:
                        result = _a.sent();
    ...
    return Ruta2Controller;
}());
exports.ruta2Controller = new Ruta2Controller();
